...
- **--rpc**: Sets the RPC URL to connect to the network (our mainnet rpc: https://rpc-storyevm.aldebaranode.xyz).
...
This guide provides only the basic bootstrapping instructions for becoming a Validator in the Story Mainnet Network. For more comprehensive operations, please refer to the [Official Documentation](https://docs.story.foundation/docs/validator-operations)