...
- **LLM_OPTION_GPU**: Enable GPU support (0 or 1).
- **LLM_OPTION_GPU_THRESHOLD**: Leave to -1 as automatic mode or you can configure your threshold, this represents number of LLM layers to be offload to GPU.
...
![Env Variable](/cortensor/env.png)
